...
export function cssBeautify(style: string, opt?: any) {
    var options: any;
    var index: number = 0;
    var length: number = style.length;
    var blocks: any[];
    ...
    var quote: any;
    var comment: boolean;
    var openbracesuffix: boolean = true;
    var autosemicolon: boolean = false;
    var trimRight: any;
